...
with col2:
    st.image(logo2, use_container_width=40)
...
def montar_sidebar(df):
    ...
    # 1. Cria três colunas na barra lateral para centralizar o logo
    col_espaco, col_logo = st.sidebar.columns([0.30, 0.60])
    
    # 2. Coloca o logo na coluna do meio (col2)
    with col_logo:
        st.image(logo, width=70)  # Ajuste o 'width' em pixels como preferir
